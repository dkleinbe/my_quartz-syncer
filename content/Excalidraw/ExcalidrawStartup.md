...
ea.onUpdateElementLinkForExportHook = (data) => {
	console.log('obsidianLink: ' + data.obsidianLink);
	console.log('originalLink: ' + data.originalLink);
	
	var reg=/file=(.*)/;
	var newUrl = data.obsidianLink.match(reg);
	console.log('newUrl : ',  newUrl[1]);
	return decodeURIComponent(newUrl[1]);
};
