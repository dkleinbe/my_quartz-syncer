...
export const TRANSCLUDED_FILE_REGEX =
	/!\[\[(.*?)(\.(svg|png|jpg|jpeg|gif|webp|mp4|mkv|mov|avi|mp3|wav|ogg|pdf))\|(.*?)\]\]|!\[\[(.*?)(\.(svg|png|jpg|jpeg|gif|webp|mp4|mkv|mov|avi|mp3|wav|ogg|pdf))\]\]/g;

export const FILE_REGEX =
	/!\[(.*?)\]\((.*?)(\.(svg|png|jpg|jpeg|gif|webp|mp4|mkv|mov|avi|mp3|wav|ogg|pdf))\)/g;
